...
**Project**: quirky-pins-map 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: build a map with a buunch of pins in random locations, new york 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/quirky-pins-map.git
cd quirky-pins-map
npm i
